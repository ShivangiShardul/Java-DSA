...
class CeilingNumberWithOrder {
    public static void main(String[] args) {
//        int[] arr = {-10, -6, -3, -1, 0, 2, 4, 7, 11, 23, 34, 50};
        int[] arr1 = {40, 35, 20, 17, 9, 4, 0, -1 , -4, -11, -22};
        int target = 55;

        ceilingNumber(arr1,target);
    }

    static void ceilingNumber(int[] arr1, int target){
        int index;
        ...
        if (index == -1) {
            ...
            System.out.println("Ceiling number of " + target + " is " + arr1[index]);
        }
    }
